...
class AuthorizationApiProvider {
  ...
  static String scope = "user-follow-read user-read-private user-read-email user-modify-playback-state user-read-playback-state user-read-currently-playing user-library-read";//TODO change this
