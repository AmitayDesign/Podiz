...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/desktop_webview_auth/desktop_webview_auth.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/device_info_plus/device_info_plus.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/external_app_launcher/external_app_launcher.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/flutter_web_auth_2/flutter_web_auth_2.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/mixpanel_flutter/mixpanel_flutter.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/soundpool/soundpool.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/spotify_sdk/spotify_sdk.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/twitter_login/twitter_login.framework"
  ...
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/spotify_sdk/SpotifyiOS.framework"
fi
